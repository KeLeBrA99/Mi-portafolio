...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative z-10 min-h-screen flex flex-col justify-center max-w-5xl mx-auto px-8 pt-28"
    >
      {/* Badge disponible */}
      ...
      {/* Nombre */}
      <h1 className="font-syne font-black leading-[0.88] tracking-tighter text-[clamp(3.2rem,10vw,7.5rem)] animate-fade-up">
        Jose<br />
        <span className="text-outline">Salamanca</span>
      </h1>

      {/* Subtitulo */}
      <p className="font-syne font-bold text-[#546e7a] mt-6 text-[clamp(0.95rem,2.5vw,1.35rem)] animate-fade-up">
